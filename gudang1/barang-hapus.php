...
$id = isset($_GET['id_barang']) ? (int)$_GET['id_barang'] : 0;

if ($id <= 0) {
    die("ID tidak valid: $id");
}

// Jalankan fungsi hapus_barang() sebelum mengeluarkan output HTML
$status = hapus_barang($id);
...
<head>
  ...
  <title>Hapus Barang barang</title>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      Swal.fire({
        ...
        text: "<?php echo ($status > 0) ? 'Barang barang berhasil dihapus' : 'Barang barang gagal dihapus'; ?>",
